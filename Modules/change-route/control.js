...
var thirdSettings = function (  ) {
    ...
    var conformation_str = "Conformation :";
   	...
   	if(v3[0]==0){
   		secondSettingDiv.innerHTML =Input_str + '<br><br>'+Start_str+'<br><br>'+conformation_str+'<br><br>'+'<IMG src="change-A.png"  width="400" height="175" ><br><br>' +animationcheck + '<input type="checkbox" name="Animation" checked="checked"/>';
   	}else if(v3[0]==1){
   		secondSettingDiv.innerHTML =Input_str + '<br><br>'+Start_str+'<br><br>'+conformation_str+'<br><br>'+'<IMG src="change-O.png"  width="400" height="175" ><br><br>' +animationcheck + '<input type="checkbox" name="Animation" checked="checked"/>';
   	}
