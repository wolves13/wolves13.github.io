...
if(carry==0){
setSeed(22+seedx, 8+seedy , { beadType: 1103, index : -3, bondNum : 0 } );
setSeed(23+seedx, 9+seedy , { beadType: 1102, index : -3, bondNum : 0 } );
setSeed(23+seedx, 10+seedy , { beadType: 1101, index : -3, bondNum : 0 } );
...
setSeed(22+seedx, 8+seedy , { beadType: 1101, index : -3, bondNum : 0 } );
setSeed(23+seedx, 9+seedy , { beadType: 1102, index : -3, bondNum : 0 } );
setSeed(23+seedx, 10+seedy , { beadType: 1103, index : -3, bondNum : 0 } );
